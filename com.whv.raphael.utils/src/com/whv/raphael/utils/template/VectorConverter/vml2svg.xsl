...
<xsl:for-each select="//html:BODY | //html:body">
    ...
    <defs>
        ...
        <!-- arrow -->
        <marker id="markerArrow" markerWidth="10" markerHeight="10" refx="0" refy="0" orient="auto" markerUnits="strokeWidth" viewBox="-10 -10 30 30"> 
        <path d="M-6,-6 L6,0 L-6,6 z" fill="#000" /> 
        </marker>
    </defs>
